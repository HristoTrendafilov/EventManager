...
namespace EventManager.API.Helpers.Extensions
{
    ...
    {
        // TODO: From the query string we get: ?fields=id,name
        // After we get the data from the database we call this extension with the passed fields to return only them
        public static IEnumerable<ExpandoObject> X_SelectOnly<TSource>(this IEnumerable<TSource> source, string fields)
        {
            if (source == null)
            {
